// === Eventa - Main JavaScript File ===

const API_BASE = 'http://localhost:3000/api'; // Change this to your actual API base URL
...
function updateNavbar() {
    ...
    // Update body classes (important for CSS)
